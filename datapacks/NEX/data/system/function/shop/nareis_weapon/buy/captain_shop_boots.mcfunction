...
execute if score @s shop matches 1 run give @s minecraft:iron_boots[custom_name='{"text":"隊長のブーツ","color":"blue","italic":false}',custom_data={nexoria_armor:"captain_shop_boots",hp:10},attribute_modifiers=[{id:"captain_shop_boots_hp",type:"minecraft:generic.max_health",amount:10,operation:"add_value",slot:"feet"}],unbreakable={},trim={pattern:"minecraft:sentry",material:"minecraft:copper"}] 1
execute if score @s shop matches 1 run tellraw @s {"text":"✔ 隊長のブーツを購入しました。","color":"green"}
