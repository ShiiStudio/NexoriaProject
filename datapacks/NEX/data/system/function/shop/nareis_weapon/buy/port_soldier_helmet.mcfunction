...
execute if score @s shop matches 1 run give @s minecraft:iron_helmet[custom_name='{"text":"港兵の兜","color":"blue","italic":false}',custom_data={nexoria_armor:"port_soldier_helmet",hp:8},attribute_modifiers=[{id:"port_soldier_helmet_hp",type:"minecraft:generic.max_health",amount:8,operation:"add_value",slot:"head"}],unbreakable={},trim={pattern:"minecraft:coast",material:"minecraft:diamond"}] 1
execute if score @s shop matches 1 run tellraw @s {"text":"✔ 港兵の兜を購入しました。","color":"green"}
