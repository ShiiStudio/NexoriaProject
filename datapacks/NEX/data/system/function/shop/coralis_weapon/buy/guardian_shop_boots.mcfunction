...
execute if score @s shop matches 1 run give @s minecraft:diamond_boots[custom_name='{"text":"守護者のブーツ","color":"blue","italic":false}',custom_data={nexoria_armor:"guardian_shop_boots",hp:12},attribute_modifiers=[{id:"guardian_shop_boots_hp",type:"minecraft:generic.max_health",amount:12,operation:"add_value",slot:"feet"}],unbreakable={},trim={pattern:"minecraft:bolt",material:"minecraft:diamond"}] 1
execute if score @s shop matches 1 run tellraw @s {"text":"✔ 守護者のブーツを購入しました。","color":"green"}
