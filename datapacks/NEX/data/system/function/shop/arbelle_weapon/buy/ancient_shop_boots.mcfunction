...
execute if score @s shop matches 1 run give @s minecraft:iron_boots[custom_name='{"text":"古代のブーツ","color":"blue","italic":false}',custom_data={nexoria_armor:"ancient_shop_boots",hp:8},attribute_modifiers=[{id:"ancient_shop_boots_hp",type:"minecraft:generic.max_health",amount:8,operation:"add_value",slot:"feet"}],unbreakable={},trim={pattern:"minecraft:ward",material:"minecraft:amethyst"}] 1
execute if score @s shop matches 1 run tellraw @s {"text":"✔ 古代のブーツを購入しました。","color":"green"}
