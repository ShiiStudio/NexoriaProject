...
execute store result score #mat0 shop run clear @s minecraft:raw_iron[custom_data={nexoria_item:"low_iron"}] 0
...
execute if score #craft shop matches 1 run clear @s minecraft:raw_iron[custom_data={nexoria_item:"low_iron"}] 4
execute if score #craft shop matches 1 run clear @s minecraft:coal[custom_data={nexoria_item:"low_coal"}] 2
