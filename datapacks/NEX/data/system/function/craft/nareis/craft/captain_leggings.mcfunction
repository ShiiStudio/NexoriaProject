...
execute if score #craft shop matches 1 run give @s minecraft:iron_leggings[custom_name='{"text":"隊長の脚甲","color":"blue","italic":false}',custom_data={nexoria_armor:"captain_leggings",hp:16},attribute_modifiers=[{id:"captain_leggings_hp",type:"minecraft:generic.max_health",amount:16,operation:"add_value",slot:"legs"}],unbreakable={},trim={pattern:"minecraft:sentry",material:"minecraft:copper"}] 1
execute if score #craft shop matches 1 run tellraw @s {"text":"✔ 隊長の脚甲を作成しました。","color":"green"}
