...
execute if score #craft shop matches 1 run give @s minecraft:iron_leggings[custom_name='{"text":"海兵の脚甲","color":"green","italic":false}',custom_data={nexoria_armor:"marine_leggings",hp:13},attribute_modifiers=[{id:"marine_leggings_hp",type:"minecraft:generic.max_health",amount:13,operation:"add_value",slot:"legs"}],unbreakable={},trim={pattern:"minecraft:coast",material:"minecraft:diamond"}] 1
execute if score #craft shop matches 1 run tellraw @s {"text":"✔ 海兵の脚甲を作成しました。","color":"green"}
